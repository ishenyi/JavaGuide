...
1. 名字与类名相同；
2. 没有返回值，但**不能用void声明构造函数**；
3. 生成类的对象时自动执行，无需调用。

---

## 22. 1 静态代码块、构造代码块、构造函数的区别和执行顺序
...
>>>>>>> 84237c1e769f0ba7a77f9ec9532b0cd8796cbbaf:Java/Java基础知识.md
...
以下链接更好的额解释了transient的用法，static修饰的变量也不会被序列化
